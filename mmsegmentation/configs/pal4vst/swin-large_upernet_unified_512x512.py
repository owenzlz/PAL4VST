_base_ = [
    '../../configs_common/_base_/models/upernet_swin.py'
]
...
data_root = '/sensei-fs/users/lingzzha/projects/AdobePAL/data/pal4vst/anyresgan'
...
checkpoint_file = './pretrain/swin_base_patch4_window12_384_22k_20220317-e5c09f74.pth'
