...
train_dataloader = dict(
    ...
    dataset=dict(
        ...
        data_root=data_root,
        data_prefix=dict(
            img_path='mmseg_images_512/train', seg_map_path='mmseg_labels_512/train'),
...
val_dataloader = dict(
    ...
    dataset=dict(
        ...
        data_root=data_root,
        data_prefix=dict(
            img_path='mmseg_images_512/val', seg_map_path='mmseg_labels_512/val'),
...
test_dataloader = dict(
    ...
    dataset=dict(
        ...
        data_root=data_root,
        data_prefix=dict(
            img_path='mmseg_images_512/test', seg_map_path='mmseg_labels_512/test'),
        pipeline=test_pipeline))
